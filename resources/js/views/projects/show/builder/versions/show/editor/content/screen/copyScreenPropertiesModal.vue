        ...
        methods: {
            ...
            copyProperties(){
                ...
                for (let index = 0; index < this.selected_properties.length; index++) {
                    ...
                    var property_value = this.localScreen[property];

                    screen_properties[ property ] = property_value;

                }

                //  Store the screen properties in the local storage
                window.localStorage.setItem('screen_properties', JSON.stringify(screen_properties));

                this.$Message.success({
                    content: 'Screen properties copied!',
                    duration: 6
                });
