    ...
    <Row :gutter="4">
        ...
        <Col :span="12" class="mt-2 mb-3">
            ...
            <textOrCodeEditor
                ...
                :value="screen.repeat.repeat_on_number.value"
            ...
            <Row :gutter="12" class="bg-grey-light border mb-3 p-2 clearfix">
                ...
                <Col :span="onNoLoopBehaviourIsExpanded ? 24 : 12">
                    ...
                    <div class="d-flex">
                        ...
                        <!-- Behaviour Method -->
                        <Select v-model="screen.repeat.repeat_on_number.on_no_loop.selected_type">
                ...
                <template v-if="screen.repeat.repeat_on_number.on_no_loop.selected_type == 'link'">
            ...
            <Row :gutter="12" class="bg-grey-light border mb-3 p-2 clearfix">
                ...
                <Col :span="afterLastLoopBehaviourIsExpanded ? 24 : 12">
                    ...
                    <div class="d-flex">
                        ...
                        <!-- Behaviour Method -->
                        <Select v-model="screen.repeat.repeat_on_number.after_last_loop.selected_type">
                            <Option v-for="(behaviour_type, index) in behaviour_types" :value="behaviour_type.value" :key="index">
                                {{ behaviour_type.name }}
                            </Option>
                        </Select>
                ...
                <template v-if="screen.repeat.repeat_on_number.after_last_loop.selected_type == 'link'">
    ...
    export default {
        ...
        computed: {
            onNoLoopBehaviourIsExpanded(){
                return ( this.screen.repeat.repeat_on_number.on_no_loop.selected_type == 'link' && 
                         this.screen.repeat.repeat_on_number.on_no_loop.link.code_editor_mode )
            },
            afterLastLoopBehaviourIsExpanded(){
                return ( this.screen.repeat.repeat_on_number.after_last_loop.selected_type == 'link' && 
                         this.screen.repeat.repeat_on_number.after_last_loop.link.code_editor_mode )
            }
        }
    };
