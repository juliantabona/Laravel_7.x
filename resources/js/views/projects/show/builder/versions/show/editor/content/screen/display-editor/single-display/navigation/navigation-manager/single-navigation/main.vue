            ...
            <Row>
                ...
                <Col class="d-flex" :span="10">
                    ...
                    <Poptip trigger="hover" width="350" placement="top" word-wrap>
                        ...
                        <List slot="content" size="small">
                            ...
                            <ListItem class="p-0">
                                ...
                                <span v-if="navigation.active.selected_type == 'conditional'">
                                ...
                                <template v-else>
                                    <span class="text-capitalize cut-text">{{ navigation.active.selected_type }}</span>
                                </template>
                            </ListItem>
                    ...
                    <div :style="{ marginTop: '-4px' }">
                        ...
                        <Poptip v-if="navigation.active.selected_type == 'conditional'" trigger="hover" width="600" placement="top" word-wrap>

                            <!-- Code sample of display  --> 
                            <pre slot="content" v-highlightjs="navigation.active.code"><code class="javascript"></code></pre>

                            <Tag v-if="navigation.active.selected_type == 'conditional'" type="border" color="cyan">Active Conditionally</Tag>

                        </Poptip>

                        <Tag v-else type="border" :color="navigation.active.selected_type == 'yes' ? 'green' : 'warning'">
                            {{ navigation.active.selected_type == 'yes'  ? 'Active' : 'InActive' }}
                        </Tag>
