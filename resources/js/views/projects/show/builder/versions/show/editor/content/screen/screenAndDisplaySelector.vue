<template>
    ...
    <div :class="[link.code_editor_mode ? '': 'd-flex']">

        <div :class="[link.code_editor_mode ? 'mb-2': 'mb-0']">

            <span class="font-weight-bold mt-1 mr-1">{{ title }}</span>
                ...
                if( this.showScreens ){
                    ...
                    var screens = this.version.builder.screens.map(function(currentScreen, index){
                        ...
                        return {
                            ...
                            disabled: self.disableCurrentScreen && currentScreen.id == (screen || {}).id
                        }
